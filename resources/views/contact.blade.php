        ...
        <div class="py-5 px-md-5 px-1  rounded-1 mx-md-5" style="background-color: #fffffff2;">
         ...
         @csrf
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="name" placeholder="e.g. Jhon Doe" class="form-control py-2" />
                    </div>
                </div>
                <div class="form-group mb-3 row">
        ...
        <div class="py-5 px-md-5 px-1 rounded-1 mx-md-5" style="background-color: #fffffff2;">
            ...
            <form action="{{ url('/contact') }}" method="POST">
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="name" placeholder="e.g. John Doe" class="form-control py-2" />
                    </div>
                </div>
                <div class="form-group mb-3 row">
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-12">
                        <textarea name="message" class="form-control" rows="8" style="padding: 0.7rem;"></textarea>
                    </div>
                </div>
                <div class="mb-3">
                    <button class="btn mt-4 text-white fs-5 fw-bold border-0 py-2 px-md-5 w-100"
            ...
            @if(isset($data))
            <div class="mt-5">
                <h2 class="fw-bold fs-1 mb-3 pb-2 text-center">Submitted Data</h2>
                <div class="form-group mb-3 row">
